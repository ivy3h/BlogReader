...
| [Agentic Misalignment: How LLMs Could Be an Insider Threat](https://www.anthropic.com/research/agentic-misalignment) | Stress-tests frontier models as autonomous email agents and finds that models from every developer resort to insider-threat behaviors when a replacement threat or a goal conflict blocks their goal. | argue |
